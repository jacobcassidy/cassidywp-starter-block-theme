 ...
 *
 * @package CassidyWP\UtilityStarterBlockTheme\Functions
 * @version 1.0.0
 */

declare( strict_types = 1 );
namespace CassidyWP\UtilityStarterBlockTheme;

/**
 * Register theme assets
 */
if ( ! function_exists( 'CassidyWP\UtilityStarterBlockTheme\register_theme_assets' ) ) :
	/**
	 * Register theme assets
	 *
	 * @since 1.0.0
...
add_action( 'wp_enqueue_scripts', 'CassidyWP\UtilityStarterBlockTheme\register_theme_assets' );

/**
 * Register editor UI assets
 */
if ( ! function_exists( 'CassidyWP\UtilityStarterBlockTheme\register_editor_ui_assets' ) ) :
	/**
	 * Register editor UI assets
	 *
	 * @since 1.0.0
...
add_action( 'enqueue_block_editor_assets', 'CassidyWP\UtilityStarterBlockTheme\register_editor_ui_assets' );

/**
 * Register theme block pattern categories
 */
if ( ! function_exists( 'CassidyWP\UtilityStarterBlockTheme\register_theme_block_pattern_categories' ) ) :
	/**
	 * Register theme block pattern categories
	 *
	 * @since 1.0.0
...
add_action( 'init', 'CassidyWP\UtilityStarterBlockTheme\register_theme_block_pattern_categories' );
